...
import {
  HunzaSkardu10DaysImages,
  HunzaSkardu10DaysData,
} from "../travelData";

function SkarduDays10() {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
  ...
  const handleBookingSubmit = async (e) => {
    ...
    const form = e.target;
    const formData = {
      tourName: "SkarduDays10", // FIXED TOUR NAME
  ...
  return (
    <div>
      ...
      <div className="bg-[#faf5ee] p-3">
        ...
        <div className="m-7 grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="bg-white rounded-lg shadow p-4">
            ...
            <p className="text-sm text-gray-600">From PKR 185,000 per person</p>
          </div>
          <div className="bg-white rounded-lg shadow p-4">
            <p className="text-lg font-semibold">Executive (5-star)</p>
            <p className="text-sm text-gray-600">From PKR 225,000 per person</p>
          </div>
        </div>
      </div>
      ...
      <div className="mx-auto p-9">
        <h2 className="text-2xl font-bold mb-4">Skardu 10-Day Tour – FAQ</h2>
        {HunzaSkardu10DaysData.map((item, index) => (
          <div
            key={index}
        ...
        <div className="grid md:grid-cols-2 gap-4">
          ...
          <div className="bg-white shadow rounded-lg p-4">
            ...
            <ul className="list-disc list-inside text-sm space-y-1">
              ...
              <li>Sarfaranga and Katpana Deserts</li>
              <li>Shigar Valley, Shigar Fort, Amburiq Mosque</li>
              <li>Deosai, Sadpara & Sheosar (seasonal)</li>
              <li>Basho Valley</li>
              <li>Naran, Babusar Pass & Lulusar (summer)</li>
            </ul>
          </div>
        </div>
