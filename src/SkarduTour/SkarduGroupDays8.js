...
import { SkarduGroup8Images, SkarduGroup8Faq } from "../travelData";

function SkarduGroupDays8() {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
  ...
  const handleBookingSubmit = async (e) => {
    ...
    const form = e.target;
    const formData = {
      tourName: "SkarduGroupDays8", // FIXED TOUR NAME
  ...
  return (
    <div>
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5 m-6">
        {SkarduGroup8Images.map((img, index) => (
          <img
            key={index}
            src={img}
            alt={`Skardu group 8 days tour image ${index + 1}`}
      ...
      <div className="bg-[#faf5ee] p-3">
        ...
        <div className="m-7 grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="bg-white rounded-lg shadow p-4">
            <p className="text-lg font-semibold">Quad Sharing</p>
            <p className="text-sm text-gray-600">PKR 35,000 per person</p>
          </div>
          <div className="bg-white rounded-lg shadow p-4">
            <p className="text-lg font-semibold">Couple Room</p>
            <p className="text-sm text-gray-600">PKR 80,000 per couple</p>
          </div>
          <div className="bg-white rounded-lg shadow p-4">
            <p className="text-lg font-semibold">Family Room</p>
      ...
      <p className="text-sm px-9">
        Public group departure with pre-set itinerary and inclusions below.
      </p>
      ...
      <div className="mx-auto p-9">
        <h2 className="text-2xl font-bold mb-4">Group Tour – FAQ</h2>
        {SkarduGroup8Faq.map((item, index) => (
          <div
            key={index}
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <div className="bg-white shadow rounded-lg p-4">
            ...
            <ul className="list-disc list-inside text-sm space-y-1">
              <li>Luxury booked transport (Coaster/Grand Cabin)</li>
              <li>Professional Tour Guide</li>
              <li>Hotel stay on sharing basis (beds + mattresses)</li>
              <li>Separate rooms for families/registered couples (limited)</li>
              <li>8 Breakfasts and 7 Dinners</li>
              <li>BBQ & Bonfire (one night)</li>
              <li>Driver & basic first aid</li>
              <li>All fuel, tolls & taxes</li>
            </ul>
          </div>
          <div className="bg-white shadow rounded-lg p-4">
            <h2 className="text-lg font-semibold mb-2">Services Excluded</h2>
            <ul className="list-disc list-inside text-sm space-y-1">
              <li>Porters, horses, trekking services</li>
              <li>Any jeeps and entry tickets</li>
              <li>Boating, jet skiing, paragliding, etc.</li>
              <li>Personal meals & room services</li>
              <li>Evacuation/rescue in emergency</li>
              <li>Anything not listed in Included</li>
            </ul>
          </div>
        </div>
...
export default SkarduGroupDays8;
