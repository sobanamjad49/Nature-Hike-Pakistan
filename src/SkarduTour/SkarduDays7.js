...
import { Skardu7DaysImages, Skardu7DaysFaqData } from "../travelData";

function SkarduDays7() {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
  ...
  const handleBookingSubmit = async (e) => {
    ...
    const form = e.target;
    const formData = {
      tourName: "SkarduDays7", // FIXED TOUR NAME
  ...
  return (
    <div>
      ...
      <div className="bg-[#faf5ee] p-3">
        ...
        <div className="m-7 grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="bg-white rounded-lg shadow p-4">
            ...
            <p className="text-sm text-gray-600">From PKR 165,000 per person</p>
          </div>
        </div>
      </div>
      ...
      <div className="mx-auto p-9">
        <h2 className="text-2xl font-bold mb-4">Skardu 7-Day Tour – FAQ</h2>
        {Skardu7DaysFaqData.map((item, index) => (
          <div
            key={index}
          ...
          <div className="bg-white shadow rounded-lg p-4">
            ...
            <ul className="list-disc list-inside text-sm space-y-1">
              ...
              <li>
                ...
                (summers) OR Manthal Buddha Rock & Soq Valley
              </li>
              <li>Basho Valley (year-round)</li>
