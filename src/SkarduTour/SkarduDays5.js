...
import {
  FairyHunzaSkardu15DaysImages,
  FairyHunzaSkardu15DaysData,
} from "../travelData";

function SkarduDays5() {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
  ...
  const handleBookingSubmit = async (e) => {
    ...
    const form = e.target;
    const formData = {
      tourName: "SkarduDays5", // FIXED TOUR NAME
  ...
  return (
    <div>
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5 m-6">
        {FairyHunzaSkardu15DaysImages.map((img, index) => (
          <img
            key={index}
            src={img}
      ...
      <div className="bg-[#faf5ee] p-3">
        <div className="flex flex-col lg:flex-row justify-between m-7">
          <p className="text-3xl font-semibold lg:w-[50%]">
            15 DAYS FAIRY MEADOWS, HUNZA, AND SKARDU VALLEY TOUR
          </p>
        ...
        <div className="m-7 grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="bg-white rounded-lg shadow p-4">
            ...
            <p className="text-sm text-gray-600">From PKR 255,000 per person</p>
          </div>
          <div className="bg-white rounded-lg shadow p-4">
            <p className="text-lg font-semibold">Deluxe (4-star)</p>
            <p className="text-sm text-gray-600">From PKR 295,000 per person</p>
          </div>
          <div className="bg-white rounded-lg shadow p-4">
            <p className="text-lg font-semibold">Executive (5-star)</p>
            <p className="text-sm text-gray-600">From PKR 355,000 per person</p>
          </div>
        </div>
      </div>
      ...
      <div className="mx-auto p-9">
        <h2 className="text-2xl font-bold mb-4">
          15-Day Fairy Meadows, Hunza & Skardu – FAQ
        </h2>
        {FairyHunzaSkardu15DaysData.map((item, index) => (
          <div
            key={index}
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <div className="bg-white shadow rounded-lg p-4">
            ...
            <ul className="list-disc list-inside text-sm space-y-1">
              <li>Pick & Drop to/from your desired location</li>
              <li>Luxury booked transport</li>
              <li>Jeeps for off-road (as required)</li>
          ...
          <div className="bg-white shadow rounded-lg p-4">
            ...
            <ul className="list-disc list-inside text-sm space-y-1">
              <li>Fairy Meadows, Beyal & Nanga Parbat viewpoints</li>
              <li>Hunza Valley, Attabad, Hussaini Bridge, Khunjerab</li>
              <li>Altit, Baltit & Duiker Eagle’s Nest</li>
              <li>Hopper Valley, Ganish, Naltar</li>
              <li>Skardu Valley, Shangrila & Kachura</li>
              <li>Deosai & Sheosar (seasonal), Khaplu & Saling</li>
              <li>Manthokha, Shigar, Sarfaranga</li>
              <li>Naran/Babusar & Lulusar (summer)</li>
            </ul>
          </div>
        </div>
