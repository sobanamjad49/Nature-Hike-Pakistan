...
import { Skardu7DaysImages, Skardu6DaysFaqData } from "../travelData";

function SkarduDays6() {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
  ...
  const handleBookingSubmit = async (e) => {
    ...
    const form = e.target;
    const formData = {
      tourName: "SkarduDays6", // FIXED TOUR NAME
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5 m-6">
        {Skardu7DaysImages.map((img, index) => (
          <img
            key={index}
            src={img}
            alt={`Skardu 6 days tour image ${index + 1}`}
      ...
      <div className="bg-[#faf5ee] p-3">
        ...
        <div className="m-7 grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="bg-white rounded-lg shadow p-4">
            ...
            <p className="text-sm text-gray-600">From PKR 95,000 per person</p>
          </div>
          <div className="bg-white rounded-lg shadow p-4">
            <p className="text-lg font-semibold">Deluxe (4-star)</p>
            <p className="text-sm text-gray-600">From PKR 115,000 per person</p>
          </div>
          <div className="bg-white rounded-lg shadow p-4">
            <p className="text-lg font-semibold">Executive (5-star)</p>
            <p className="text-sm text-gray-600">From PKR 145,000 per person</p>
          </div>
        </div>
      </div>
      ...
      <p className="text-sm px-9">
        This tour plan is available for private customized trips only! (See the
        end of the page to know what a private customized tour is.)
      </p>
      ...
      <div className="mx-auto p-9">
        <h2 className="text-2xl font-bold mb-4">Skardu 6-Day Tour – FAQ</h2>
        {Skardu6DaysFaqData.map((item, index) => (
          <div
            key={index}
      ...
      <div className="max-w-6xl mx-auto p-4 text-gray-800 space-y-6">
        <div className="grid md:grid-cols-2 gap-4">
          <div className="bg-white shadow rounded-lg p-4">
            ...
            <ul className="list-disc list-inside text-sm space-y-1">
              ...
              <li>Accommodation: On-panel hotels or your selected hotels</li>
              <li>Tour Guide: Professional and knowledgeable guide</li>
              <li>Driver: Personal driver for the whole trip</li>
              <li>Driver Expenses: All driver-related expenses covered</li>
              <li>Breakfasts: Daily complimentary breakfasts</li>
              <li>Tolls, Taxes, and Fuel: All-inclusive</li>
              <li>On-Call Assistance: 24/7 during the trip</li>
            </ul>
          </div>
          ...
          <div className="bg-white shadow rounded-lg p-4">
            ...
            <ul className="list-disc list-inside text-sm space-y-1">
              <li>Hazara Motorway and Karakoram Highway</li>
              <li>Skardu Valley</li>
              <li>Shangrila Resort, Lower & Upper Kachura Lakes</li>
              <li>Manthokha Waterfall and Sarfaranga Cold Desert</li>
              <li>Shigar Valley, Shigar Fort, and Amburiq Mosque</li>
              <li>
                Deosai, Sadpara Lake, Sheosar Lake, Kala Pani, Bara Pani
                (summers) OR Basho Valley
              </li>
              <li>Naran, Babusar Pass, and Lulusar Lake (summers)</li>
            </ul>
          </div>
        </div>
        ...
        <div className="bg-white shadow rounded-lg p-4">
          ...
          <p className="text-sm">
            A Private Customized tour is a tour that is altered to the exact
            needs of a group (family, friends, or colleagues), a couple, or an
          ...
          <ul className="list-disc list-inside text-sm mt-2 space-y-1">
            <li>Itinerary tailored to your preferences</li>
            <li>Any group size</li>
            <li>Choose hotel and service categories</li>
            <li>Flexible travel dates</li>
            <li>Pricing varies with flexibility and choices</li>
          </ul>
