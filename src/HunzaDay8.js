...
function HunzaDay8() {
  ...
  const handleBookingSubmit = async (e) => {
    ...
    const form = e.target;
    const formData = {
      tourName: "HunzaDay8", // FIXED TOUR NAME
        ...
        <div className="flex flex-col lg:flex-row justify-between m-7">
          <div>
            <p className="text-3xl font-semibold lg:w-[50%]">
              8 DAYS HUNZA AND SKARDU VALLEY TOUR – GILGIT BALTISTAN
            </p>
          </div>
        ...
        <div className="grid md:grid-cols-2 gap-4">
          ...
          <div className="bg-white shadow rounded-lg p-4">
            ...
            <ul className="list-disc list-inside text-sm space-y-1">
              ...
              <li>Meals: 7 Breakfasts, 6 Dinners</li>
          ...
          <div className="bg-white shadow rounded-lg p-4">
            ...
            <ul className="list-disc list-inside text-sm space-y-1">
              ...
              <li>Jeep charges for Skardu & Naltar Valley</li>
              <li>Boating, Jet ski, or other optional activities</li>
              <li>Lunch or personal meal orders</li>
              <li>Anything not listed in Services Included</li>
            </ul>
          </div>
          ...
          <div className="bg-white shadow rounded-lg p-4 md:col-span-2">
            ...
            <ul className="list-disc list-inside text-sm grid grid-cols-2 gap-1">
              <li>Skardu Valley</li>
              <li>Shangrila Resort & Lakes</li>
              <li>Khaplu Valley & Serena Fort</li>
              <li>Saling Valley & Fish Farm</li>
              <li>Manthokha & Khamosh Waterfalls</li>
              <li>Sarfaranga & Katpana Desert</li>
              <li>Shigar Valley & Shigar Fort</li>
              <li>Deosai & Sheosar Lake</li>
              <li>Basho & Chunda Valleys</li>
              <li>Naran, Babusar Pass & Lulusar Lake</li>
            </ul>
          </div>
