...
function HunzaDay10() {
  ...
  const handleBookingSubmit = async (e) => {
    ...
    const form = e.target;
    const formData = {
      tourName: "HunzaDay10", // FIXED TOUR NAME
      ...
      <div className="bg-[#faf5ee] p-3">
        <div className="flex flex-col lg:flex-row justify-between m-7">
          <p className="text-3xl font-semibold lg:w-[50%]">
            10 DAYS HUNZA AND SKARDU VALLEY TOUR
          </p>
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <div className="bg-white shadow rounded-lg p-4">
            ...
            <ul className="list-disc list-inside text-sm space-y-1">
              <li>Pick & Drop from desired location</li>
              <li>Luxury transport</li>
              <li>Jeep charges for off-road as required</li>
              <li>Accommodation at on-panel hotels</li>
              <li>Tour Guide</li>
          ...
          <div className="bg-white shadow rounded-lg p-4">
            ...
            <ul className="list-disc list-inside text-sm space-y-1">
              <li>Hunza Valley & Karimabad</li>
              <li>Khunjerab Pass</li>
              <li>Altit & Baltit Forts</li>
              <li>Attabad Lake & Tunnels</li>
              <li>Sarfaranga Desert</li>
              <li>Skardu Valley</li>
              <li>Manthokha Waterfall</li>
              <li>Shigar Valley & Fort</li>
