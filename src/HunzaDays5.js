...
import { HunzaDay5, HunzafaqData } from "./travelData";
function HunzaDays5() {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
  ...
  const handleBookingSubmit = async (e) => {
    ...
    const form = e.target;
    const formData = {
      tourName: "HunzaDays5", // FIXED TOUR NAME
    ...
    <div>
      ...
      <div className="bg-[#faf5ee] p-3">
        <div className="flex flex-col lg:flex-row  justify-between m-7 ">
          <div>
            <p className="text-3xl font-semibold justify-start w-auto lg:w-[50%] ">
              5 DAYS HUNZA, NALTAR, AND KHUNJERAB PUBLIC GROUP TOUR
            </p>
          </div>
      ...
      <span className="p-9 text-xl">
        <strong>Quad Sharing:</strong> PKR 25,000/person
      </span>
      <br />
      <span className="p-9 text-xl">
        <strong>Couple Price:</strong> PKR 58,000
      </span>
      ...
      <div className=" mx-auto p-9">
        <h2 className="text-2xl font-bold  mb-4">
          Hunza & Naltar 5-Day Tour – FAQ
        </h2>
        {HunzafaqData.map((item, index) => (
          <div
            key={index}
            className="border-b bg-[#faf5ee]   shadow-md border-gray-200 "
          >
            <button
              className="w-full text-left  m-2  text-xl py-3 px-6 font-medium flex justify-between items-center focus:outline-none"
            ...
            {openIndex === index && (
              <div className="bg-white text-sm text-gray-700 whitespace-pre-line m-2   py-3 px-6 ">
                {item.details}
              </div>
            )}
          </div>
        ...
        <div className="grid md:grid-cols-2 gap-4">
          ...
          <div className="bg-white shadow rounded-lg p-4">
            ...
            <ul className="list-disc list-inside text-sm space-y-1">
              ...
              <li>Expenses of driver</li>
              <li>Hotel accommodation on sharing basis</li>
              <li>Separate rooms for families/registered couples</li>
              <li>Professional tour guide</li>
              <li>BBQ & Bonfire night</li>
              <li>Meals: 5 Breakfasts, 4 Dinners</li>
          ...
          <div className="bg-white shadow rounded-lg p-4">
            ...
            <ul className="list-disc list-inside text-sm space-y-1">
              <li>Entry tickets (forts, parks, bridges, etc.)</li>
              <li>Jeep charges for Naltar Valley</li>
              <li>Boating, Jet ski, other activities</li>
              <li>Lunch or personal meal orders</li>
              <li>Anything not in "Services Included"</li>
            </ul>
          </div>
          ...
          <div className="bg-white shadow rounded-lg p-4 md:col-span-2">
            ...
            <ul className="list-disc list-inside text-sm grid grid-cols-2 gap-1">
              <li>Hunza Valley</li>
              <li>Naltar Valley & Lakes</li>
              <li>Khunjerab Pass</li>
              <li>Karakoram Highway</li>
              <li>Attabad Lake</li>
              <li>Altit & Baltit Forts</li>
              <li>Karimabad Bazaar</li>
              <li>Passu Cones & Gulmit</li>
              <li>Rakaposhi Viewpoint</li>
              <li>3 Mountain Ranges Junction</li>
              <li>Nanga Parbat Viewpoint</li>
              <li>Naran, Lulusar Lake, Babusar Top (summer)</li>
            </ul>
          </div>
          ...
          <div className="bg-white shadow rounded-lg p-4">
            ...
            <ul className="list-disc list-inside text-sm space-y-1">
              <li>
                <strong>Lahore:</strong> Daewoo Terminal Thokar / Gulberg III
              </li>
              <li>
                <strong>Islamabad/Rawalpindi:</strong> Faizabad Bus Terminal /
                Daewoo Terminal Near EME
              </li>
            </ul>
          </div>
          ...
          <div className="bg-white shadow rounded-lg p-4">
            ...
            <p className="text-sm">
              ...
              <strong>100% advance paid is non-refundable</strong>.
            </p>
          </div>
          ...
          <div className="bg-white shadow rounded-lg p-4 md:col-span-2">
            ...
            <p className="text-sm">
              Contact our team to check seat availability. Advance payment is
              required to confirm booking.
            </p>
            <p className="text-sm mt-2">
              <strong>Phone:</strong> 0303-4364467 | 0310-6406568
            </p>
            <p className="text-sm">
              <strong>Email:</strong> info@naturehikepakistan.pk
            </p>
          </div>
