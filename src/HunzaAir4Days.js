...
import { AirHunza4DaysImages, AirHunza4DaysData } from "./travelData";

function HunzaAir4Days() {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
  ...
  const handleBookingSubmit = async (e) => {
    ...
    const form = e.target;
    const formData = {
      tourName: "HunzaAir4Days", // FIXED TOUR NAME
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5 m-6">
        {AirHunza4DaysImages.map((img, index) => (
          <img
            key={index}
            src={img}
            alt=""
      ...
      <div className="mx-auto p-9">
        <h2 className="text-2xl font-bold mb-4">Air Hunza 4-Day Tour – FAQ</h2>

        {AirHunza4DaysData.map((item, index) => (
          <div
            key={index}
        ...
        <div className="grid md:grid-cols-2 gap-4">
          ...
          <div className="bg-white shadow rounded-lg p-4">
            ...
            <ul className="list-disc list-inside text-sm space-y-1">
              ...
              <li>Rakaposhi View-point & Nanga Parbat View-point</li>
