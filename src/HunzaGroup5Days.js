...
import { HunzaGroup5images, HunzaGroup5Faq } from "./travelData";

function HunzaGroup5Days() {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
  ...
  const handleBookingSubmit = async (e) => {
    ...
    const form = e.target;
    const formData = {
      tourName: "HunzaGroup5Days", // FIXED TOUR NAME
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5 m-6">
        {HunzaGroup5images.map((img, index) => (
          <img
            key={index}
            src={img}
            alt={`Hunza group 5 days tour image ${index + 1}`}
      ...
      <div className="px-9 space-y-2 text-sm">
        ...
        <p>Quad Sharing: PKR 25,000/person</p>
        <p>Couple Price: PKR 58,000</p>
      </div>
      ...
      <div className="mx-auto p-9">
        <h2 className="text-2xl font-bold mb-4">
          Hunza Group 5-Day Tour – FAQ
        </h2>
        {HunzaGroup5Faq.map((item, index) => (
          <div
            key={index}
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <div className="bg-white shadow rounded-lg p-4">
            ...
            <ul className="list-disc list-inside text-sm space-y-1">
              ...
              <li>Meals (5 Breakfasts and 4 Dinners)</li>
          ...
          <div className="bg-white shadow rounded-lg p-4">
            ...
            <ul className="list-disc list-inside text-sm space-y-1">
              ...
              <li>Boating, jet ski, or similar activities</li>
              <li>Lunch or any personal food orders</li>
...
export default HunzaGroup5Days;
