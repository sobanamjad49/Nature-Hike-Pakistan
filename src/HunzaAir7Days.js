...
import { AirHunza7DaysImages, AirHunza7DaysData } from "./travelData";
function HunzaAir7Days() {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
  ...
  const handleBookingSubmit = async (e) => {
    ...
    const form = e.target;
    const formData = {
      tourName: "HunzaAir7Days", // FIXED TOUR NAME
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5 m-6">
        {AirHunza7DaysImages.map((img, index) => (
          <img
            key={index}
            src={img}
            alt="Hunza & Skardu by air 7 days"
      ...
      <div className="bg-[#faf5ee] p-3">
        <div className="flex flex-col lg:flex-row justify-between m-7">
          <p className="text-3xl font-semibold lg:w-[50%]">
            7 DAYS BY-AIR HUNZA AND SKARDU TOUR
          </p>
      ...
      <p className="text-base font-semibold px-9 py-2">
        Price: Rs 295,000 (2 Persons) • Rs 52,000 per additional person
      </p>
      ...
      <div className="mx-auto p-9">
        <h2 className="text-2xl font-bold mb-4">
          Air Hunza & Skardu 7-Day Tour – FAQ
        </h2>

        {AirHunza7DaysData.map((item, index) => (
          <div
            key={index}
        ...
        <div className="grid md:grid-cols-2 gap-4">
          ...
          <div className="bg-white shadow rounded-lg p-4">
            ...
            <ul className="list-disc list-inside text-sm space-y-1">
              ...
              <li>Deosai or Basho Valley</li>
              <li>Hunza Valley & Local Karimabad Market</li>
              <li>Khunjerab Pass, Passu Cones, Attabad Lake</li>
