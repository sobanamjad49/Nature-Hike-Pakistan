...
import { Kalam2DaysImages, Kalam2DaysData } from "../travelData";
...
function Kalam2Days() {
  ...
  const handleBookingSubmit = async (e) => {
    ...
    const form = e.target;
    const formData = {
      tourName: "Kalam2Days", // FIXED TOUR NAME
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5 m-6">
        {Kalam2DaysImages.map((img, index) => (
          <img
            key={index}
            src={img}
            alt="Kalam 2 days"
      ...
      <div className="mx-auto p-9">
        <h2 className="text-2xl font-bold mb-4">Kalam 2-Day Tour – FAQ</h2>
        {Kalam2DaysData.map((item, index) => (
          <div
            key={index}
        ...
        <div className="grid md:grid-cols-2 gap-4">
          ...
          <div className="bg-white shadow rounded-lg p-4">
            ...
            <ul className="list-disc list-inside text-sm space-y-1">
              ...
              <li>Mingora / Fizagat</li>
              <li>Kalam Bazaar</li>
              <li>Ushu Forest (time permitting)</li>
            </ul>
          </div>
        </div>
