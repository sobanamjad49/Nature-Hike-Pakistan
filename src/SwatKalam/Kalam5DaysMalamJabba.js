...
import {
  Kalam5DaysMalamJabbaImages,
  Kalam5DaysMalamJabbaData,
} from "../travelData";

function Kalam5DaysMalamJabba() {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
  ...
  const handleBookingSubmit = async (e) => {
    ...
    const form = e.target;
    const formData = {
      tourName: "Kalam5DaysMalamJabba", // FIXED TOUR NAME
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5 m-6">
        {Kalam5DaysMalamJabbaImages.map((img, index) => (
          <img
            key={index}
            src={img}
            alt="Kalam 5 days Malam Jabba"
      ...
      <div className="bg-[#faf5ee] p-3">
        <div className="flex flex-col lg:flex-row justify-between m-7">
          <p className="text-3xl font-semibold lg:w-[50%]">
            5 DAYS KALAM, MAHODAND LAKE & MALAM JABBA
          </p>
      ...
      <div className="mx-auto p-9">
        <h2 className="text-2xl font-bold mb-4">
          Kalam 5-Day (Malam Jabba) – FAQ
        </h2>
        {Kalam5DaysMalamJabbaData.map((item, index) => (
          <div
            key={index}
        ...
        <div className="grid md:grid-cols-2 gap-4">
          ...
          <div className="bg-white shadow rounded-lg p-4">
            ...
            <ul className="list-disc list-inside text-sm space-y-1">
              ...
              <li>Mahodand Lake (jeep)</li>
              <li>Optional Blue Water / Kumrat Viewpoints</li>
            </ul>
          </div>
        </div>
...
export default Kalam5DaysMalamJabba;
