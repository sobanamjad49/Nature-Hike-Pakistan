...
import { Kalam7DaysImages, Kalam7DaysData } from "../travelData";
...
function Kalam7Days() {
  ...
  const handleBookingSubmit = async (e) => {
    ...
    const form = e.target;
    const formData = {
      tourName: "Kalam7Days", // FIXED TOUR NAME
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5 m-6">
        {Kalam7DaysImages.map((img, index) => (
          <img
            key={index}
            src={img}
            alt="Kalam 7 days"
      ...
      <div className="bg-[#faf5ee] p-3">
        <div className="flex flex-col lg:flex-row justify-between m-7">
          <p className="text-3xl font-semibold lg:w-[50%]">
            7 DAYS MALAM JABBA, KALAM & SWAT VALLEY
          </p>
      ...
      <div className="mx-auto p-9">
        <h2 className="text-2xl font-bold mb-4">Kalam 7-Day Tour – FAQ</h2>
        {Kalam7DaysData.map((item, index) => (
          <div
            key={index}
        ...
        <div className="grid md:grid-cols-2 gap-4">
          ...
          <div className="bg-white shadow rounded-lg p-4">
            ...
            <ul className="list-disc list-inside text-sm space-y-1">
              ...
              <li>Green Top / Desan Meadows (jeep)</li>
              <li>Shangla / local exploration (time permitting)</li>
            </ul>
          </div>
        </div>
