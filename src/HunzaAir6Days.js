...
import { AirHunza6DaysImages, AirHunza6DaysData } from "./travelData";

function HunzaAir6Days() {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
  ...
  const handleBookingSubmit = async (e) => {
    ...
    const form = e.target;
    const formData = {
      tourName: "HunzaAir6Days", // FIXED TOUR NAME
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5 m-6">
        {AirHunza6DaysImages.map((img, index) => (
          <img
            key={index}
            src={img}
            alt={`Air Hunza 6 days tour image ${index + 1}`}
      ...
      <div className="bg-[#faf5ee] p-3">
        <div className="flex flex-col lg:flex-row justify-between m-7">
          <p className="text-3xl font-semibold lg:w-[50%]">
            6 DAYS BY-AIR HUNZA, MINAPIN NAGAR, AND NALTAR VALLEY TOUR
          </p>
      ...
      <p className="text-base font-semibold px-9 py-2">
        Price: Rs 225,000 (2 Persons) • Rs 48,000 per additional person
      </p>
      ...
      <div className="mx-auto p-9">
        <h2 className="text-2xl font-bold mb-4">Air Hunza 6-Day Tour – FAQ</h2>

        {AirHunza6DaysData.map((item, index) => (
          <div
            key={index}
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <div className="bg-white shadow rounded-lg p-4">
            ...
            <ul className="list-disc list-inside text-sm space-y-1">
              <li>Pick & Drop to/from the airport</li>
          ...
          <div className="bg-white shadow rounded-lg p-4">
            ...
            <ul className="list-disc list-inside text-sm space-y-1">
              <li>Hunza Valley & Local Karimabad Market</li>
              <li>Khunjerab Pass, Passu Cones, and Borith Lake</li>
              <li>Altit & Baltit Forts</li>
              <li>Eagle’s Nest Hunza (Duiker)</li>
              <li>Minapin Nagar & Rakaposhi viewpoint</li>
              <li>Attabad Lake</li>
              <li>Hopper Valley & Hopper Glacier</li>
              <li>Gulmit Village & Ondra Poygah</li>
              <li>Naltar Valley</li>
              <li>Local Karimabad Market</li>
            </ul>
          </div>
        </div>
