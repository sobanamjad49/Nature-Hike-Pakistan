...
import { SiriPayeImages, SiriPayeFaqData } from "../travelData";
...
function SiriPaye() {
  ...
  const handleBookingSubmit = async (e) => {
    ...
    const form = e.target;
    const formData = {
      tourName: "SiriPaye", // FIXED TOUR NAME
  ...
  return (
    <div>
      ...
      <span className="p-9 text-xl">
        <strong>Quad Sharing:</strong> PKR 31,000/person
      </span>
      <br />
      <span className="p-9 text-xl">
        <strong>Couple Price:</strong> PKR 76,000
      </span>
      ...
      <div className="mx-auto p-9">
        <h2 className="text-2xl font-bold mb-4">Siri Paye Tour – FAQ</h2>
        {SiriPayeFaqData.map((item, index) => (
          <div
            key={index}
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <div className="bg-white shadow rounded-lg p-4">
            ...
            <ul className="list-disc list-inside text-sm space-y-1">
              ...
              <li>4x4 Jeep for Shogran & Siri Paye</li>
          ...
          <div className="bg-white shadow rounded-lg p-4">
            ...
            <ul className="list-disc list-inside text-sm space-y-1">
              <li>Kiwai Waterfall</li>
              <li>Shogran Meadows</li>
              <li>Siri Lake</li>
              <li>Paye Meadows</li>
              <li>Makra Peak views</li>
            </ul>
          </div>
        </div>
