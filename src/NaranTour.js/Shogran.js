...
import { ShogranImages, ShogranFaqData } from "../travelData";
function Shogran() {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
  ...
  const handleBookingSubmit = async (e) => {
    ...
    const form = e.target;
    const formData = {
      tourName: "Shogran", // FIXED TOUR NAME
  ...
  return (
    <div>
      ...
      <span className="p-9 text-xl">
        <strong>Quad Sharing:</strong> PKR 32,000/person
      </span>
      <br />
      <span className="p-9 text-xl">
        <strong>Couple Price:</strong> PKR 78,000
      </span>
      ...
      <div className="mx-auto p-9">
        <h2 className="text-2xl font-bold mb-4">
          Shogran & Siri Paye Tour – FAQ
        </h2>
        {ShogranFaqData.map((item, index) => (
          <div
            key={index}
        ...
        <div className="grid md:grid-cols-2 gap-4">
          ...
          <div className="bg-white shadow rounded-lg p-4">
            ...
            <ul className="list-disc list-inside text-sm space-y-1">
              ...
              <li>Siri Lake</li>
              <li>Paye Meadows & Makra Peak views</li>
              <li>Kunhar River</li>
            </ul>
          </div>
        </div>
