...
import { BabusarTopImages, BabusarTopFaqData } from "../travelData";
function BabuSarTop() {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
  ...
  const handleBookingSubmit = async (e) => {
    ...
    const form = e.target;
    const formData = {
      tourName: "BabuSarTop", // FIXED TOUR NAME
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5 m-6">
        {BabusarTopImages.map((img, index) => (
          <img
            key={index}
            src={img}
            alt="Babusar Top"
      ...
      <span className="p-9 text-xl">
        <strong>Quad Sharing:</strong> PKR 38,000/person
      </span>
      <br />
      <span className="p-9 text-xl">
        <strong>Couple Price:</strong> PKR 85,000
      </span>
      ...
      <div className="mx-auto p-9">
        <h2 className="text-2xl font-bold mb-4">Babusar Top Tour – FAQ</h2>
        {BabusarTopFaqData.map((item, index) => (
          <div
            key={index}
        ...
        <div className="grid md:grid-cols-2 gap-4">
          ...
          <div className="bg-white shadow rounded-lg p-4">
            ...
            <ul className="list-disc list-inside text-sm space-y-1">
              ...
              <li>Naran Bazaar</li>
              <li>Lulusar Lake</li>
              <li>Gitidas Meadows</li>
              <li>Babusar Pass Top (4,173m)</li>
            </ul>
          </div>
        </div>
